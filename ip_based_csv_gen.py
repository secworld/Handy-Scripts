...
def csv_func(file_obj):
    input_IP = raw_input("Please Enter the IP Address  :  ")
    path = "ip_based_Unfixed_Vulneranilities.csv"
...
src_file = "/home/user/Desktop/Indusind/Scripts/csv_report/ip_based_Unfixed_Vulneranilities.csv"
